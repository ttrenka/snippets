	...
	themes.Claro = new Theme({
		...
		axis:{
			...
			tick: {	// used as a foundation for all ticks
				color:     "#888c76",
				position:  "center",
				font:      "normal normal normal 7pt 'Helvetica Neue', Helvetica, Arial, sans-serif",	// labels on axis
				fontColor: "#888c76"								// color of labels
			} /*,
			title: {
				font: "normal normal normal 9pt 'Helvetica Neue', Helvetica, Arial, sans-serif"
			} */
		},
		series: {
			stroke:  {width: 2.5, color: "#fff"},
			outline: null,
			font: "normal normal normal 7pt 'Helvetica Neue', Helvetica, Arial, sans-serif",
			fontColor: "#131313"
		},
		marker: {
			stroke:  {width: 1.25, color: "#131313"},
			outline: {width: 1.25, color: "#131313"},
			font: "normal normal normal 8pt 'Helvetica Neue', Helvetica, Arial, sans-serif",
			fontColor: "#131313"
		},
		seriesThemes: [
			...
			{fill: g(defaultFill, "#0f7f34", "#37ad5e")},
			{fill: g(defaultFill, "#6e1f1b", "#9e2d27")},
			{fill: g(defaultFill, "#b29c38", "#ffe884")},
			{fill: g(defaultFill, "#42b2ab", "#41ccc2")},
			{fill: g(defaultFill, "#899407", "#a1ad10")},
			{fill: g(defaultFill, "#cc55bb", "#ff6bea")}
		],
		markerThemes: [
			...
			{fill: "#0f7f34", stroke: {color: "#fff"}},
			{fill: "#6e1f1b", stroke: {color: "#fff"}},
			{fill: "#b29c38", stroke: {color: "#fff"}},
			{fill: "#42b2ab", stroke: {color: "#fff"}},
			{fill: "#899407", stroke: {color: "#fff"}},
			{fill: "#cc55bb", stroke: {color: "#fff"}}
		]
	});
