...
function(lang, Theme, Default){
	/****************************************************************
	 *	Dual Axis Linearea chart Neon Red theme (Entrance Pages)
	 ****************************************************************/ 
	var variations = {};
	...
	var dark = {
		gradients: {
			value: {
				stops: [
					{ offset: "0%", "stop-color": "#fc545b", "stop-opacity": "0" },
					{ offset: "90%", "stop-color": "#fc545b", "stop-opacity": "0.9" }
				]
			},
			compare: {
				stops: [
					{ offset: "0%", "stop-color": "#f78e59", "stop-opacity": "0" },
					{ offset: "90%", "stop-color": "#f78e59", "stop-opacity": "0.9" }
				]
			}
		},
		compareLine: {
	...
	var light = {
		...
		gradients: {
			value: {
				stops: [
					{ offset: "0%", "stop-color": "#fc545b", "stop-opacity": "0" },
					{ offset: "90%", "stop-color": "#fc545b", "stop-opacity": "1" }
				]
			},
			compare: {
				stops: [
					{ offset: "0%", "stop-color": "#fc545b", "stop-opacity": "0" },
					{ offset: "90%", "stop-color": "#fc545b", "stop-opacity": "0.8" }
				]
			}
		},
		compareLine: {
